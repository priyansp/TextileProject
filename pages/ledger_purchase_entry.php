                  ...
                  <div class="x_content">
                    ...
                    <form action="../form_actions/ledger_add_entry.php" method="post" id="Ledger-Entry-Form" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" step="0.01" id="Amount" name="Amount" class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Date">Entry for Date<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="Date" name="Date" class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <label class="btn">
                              <input type="radio" name="Entry-Type" value="1" checked="checked">Credit
                            </label>
                            <label class="btn">
                              <input type="radio" name="Entry-Type" value="2" >Debit
                            </label>
                        </div>
                      </div>                                            
